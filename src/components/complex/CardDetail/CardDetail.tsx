...
export default function CardDetail({
  ...
  const imageUrl = getStrapiMedia(product.gallery.images[0].url) || "";
    ...
    <div className='container'>
      ...
      <div className='flex flex-col md:flex-row-reverse items-center w-full justify-around '>
        ...
        <div className='flex flex-col justify-center items-center py-5 md:px-10'>
          ...
          <div>
            <div>
              <h4 className='py-2'>{t("sizeTitle")}</h4>
              <p>{product.size}</p>
            </div>
            <div className='pt-5'>
              <h4 className='py-2'>{t("materialTitle")}</h4>
              <p className='text-black'>{product.material}</p>
            </div>
            <div className='pt-5'>
              <h4 className='py-2'>{t("includesTitle")}</h4>
              <p className='text-black'>{product.includes}</p>
