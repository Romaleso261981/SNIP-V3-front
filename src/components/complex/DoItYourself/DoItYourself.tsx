    ...
    <div className='w-full px-4 md:px-8'>
      ...
      <div className='text-center flex flex-col items-center mt-14 mb-14'>
        ...
        <h4 className='text-black font-montserrat font-weight-500 text-2xs'>
          {data ? data.hero.title : t("examplesText")}
        </h4>
      </div>
    </div>
  );
